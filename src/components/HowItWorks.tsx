...
const HowItWorksPage = () => {
 ...
 <Helmet>
  <title>Real Estate Investment Made Easy | GroupDealz</title>

    
    <meta name="description" content="Invest from ₹10L in RERA-approved properties, earn rental income from Day 1, and enjoy 14–16% returns with flexible exit options via GroupDealz." />

    
    <meta name="keywords" content="Real estate investment India, co-invest in property, RERA registered properties, passive rental income, invest in real estate from ₹10 lakh, high return property investment, shared property ownership, secure real estate platform, GroupDealz investment process, premium real estate India" />

   
    <meta name="author" content="GroupDealz" />
    ...
    <meta property="og:title" content="Real Estate Investment Made Easy | GroupDealz" />
    <meta property="og:description" content="Invest from ₹10L in RERA-approved properties, earn rental income from Day 1, and enjoy 14–16% returns with flexible exit options via GroupDealz." />
